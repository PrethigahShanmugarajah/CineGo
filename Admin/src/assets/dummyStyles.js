...
export const addMoviePageStyles = {
  ...
  pageContainer:
    "min-h-screen p-4 sm:p-6 bg-gradient-to-b from-black via-gray-900 to-gray-800 text-gray-100",
  mainContainer:
    "max-w-6xl mx-auto bg-gradient-to-r from-black via-red-900 to-black/80 border-2 border-red-700 rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl",
  ...
  input:
    "w-full rounded-lg p-3 bg-black/20 border border-red-600 placeholder-gray-400",
  ...
  // File upload areas
  uploadContainer:
    "border-2 border-dashed border-red-700 rounded-lg p-3 bg-black/30",
  uploadContent:
  ...
  gridCols2Md3:
    "sm:col-span-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4",
  ...
  addSlotButton:
    "flex items-center gap-2 px-3 py-1 rounded-full bg-red-700 text-sm",
  addSlotIcon: "",
  ...
  uploaderItemInput:
    "w-full rounded-md p-1 text-sm bg-black/10 border border-gray-700",

  // Named uploader
  namedUploaderGrid: "grid grid-cols-1 gap-3",
  namedUploaderItem:
    "relative flex gap-2 items-center bg-black/30 p-2 rounded-md",
  namedUploaderImage: "w-20 h-20 object-cover rounded-md",
  namedUploaderInput:
    "w-full rounded-lg p-2 bg-black/20 border border-gray-700 mb-2",
  ...
  submitButton:
    "px-6 py-2 rounded-lg bg-red-700 font-semibold w-full sm:w-auto",
...
export const styles2 = {
  ...
  // Header styles
  headerContainer:
    "mb-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4",
  formContainer: "flex items-center gap-3 w-full lg:w-auto",

  // Form elements
  select:
    "px-3 py-2 rounded-lg bg-gray-900 border border-red-800 text-sm outline-none focus:ring-2 focus:ring-red-600",
  clearButton:
    "px-3 py-2 rounded-lg bg-red-700 text-white text-sm hover:brightness-95",
  ...
  bookingCard:
    "bg-gradient-to-r from-gray-900 to-black border border-red-800 rounded-xl p-4 shadow-lg flex flex-col justify-between",

  // Card content
  movieIconContainer:
    "w-12 h-12 rounded-md bg-red-800 flex items-center justify-center text-white",
...
export const styles3 = {
  ...
  dashboardPageContainer:
    "min-h-screen bg-black text-gray-100 p-4 sm:p-6 lg:p-8",
  maxWidthContainer: "max-w-6xl mx-auto",
  ...
  dashboardTitle:
    "text-2xl sm:text-3xl md:text-4xl font-extrabold text-red-500",
  ...
  summaryCard:
    "rounded-2xl border border-red-800 bg-gradient-to-b from-gray-900/60 to-black p-4 shadow-lg",
  ...
  summaryBadge:
    "px-3 py-2 rounded-lg bg-red-800/20 text-red-300 text-sm font-medium",
  summaryNote: "mt-3 text-xs text-gray-500",

  // Movies section
  moviesSection:
    "rounded-2xl border border-red-800 bg-gradient-to-b from-gray-900 to-black p-4 shadow-inner",
  ...
  mobileCard:
    "bg-gradient-to-b from-gray-900/70 to-black border border-red-800 rounded-xl p-4 shadow-sm",
...
export const styles4 = {
  ...
  logoIcon:
    "flex items-center justify-center w-10 h-10 bg-red-600 rounded-full transform rotate-12 hover:rotate-0 transition-transform duration-300",
  logoIconInner: "w-6 h-6 text-white transform -rotate-12",
  logoText:
    "font-['Impact'] text-2xl text-white tracking-wider bg-gradient-to-r from-red-600 to-red-400 bg-clip-text",
  desktopNav: "hidden lg:flex lg:space-x-4",
  mobileMenuButton:
    "inline-flex items-center justify-center p-2 rounded-md text-red-200 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-600",
  mobileMenuIcon: "w-6 h-6",

  // Navigation links
  navLinkBase:
    "group flex items-center space-x-2 px-4 py-2 rounded-full border border-red-800 transition-all duration-300 transform",
  navLinkActive:
    "bg-red-700 hover:from-red-800 scale-105 shadow-lg shadow-red-900/50",
  navLinkInactive:
    "bg-gradient-to-r from-red-900 to-black hover:from-red-800 hover:to-black",
  ...
  navLinkTextBase:
    "font-['Arial_Black'] text-sm tracking-wide transition-colors",
  ...
  mobileMenuPanel:
    "fixed top-0 right-0 h-full w-72 max-w-full bg-gradient-to-b from-black/95 to-black/90 border-l border-red-800 shadow-2xl transform transition-transform duration-300 lg:hidden",
  mobileMenuPanelHeader:
    "flex items-center justify-between px-4 py-4 border-b border-red-800",
  mobileMenuPanelNav: "px-4 py-6 space-y-3",
  mobileMenuPanelFooter:
    "absolute bottom-0 left-0 right-0 p-4 border-t border-red-800",
...
export const styles5 = {
  ...
  dashboardPageContainer:
    "min-h-screen bg-black text-gray-100 p-4 sm:p-6 lg:p-8",
  listMoviesContainer:
    "min-h-screen p-4 sm:p-6 md:p-6 lg:p-6 bg-gradient-to-br from-gray-900 via-black to-gray-800 text-gray-100",
  maxWidthContainer: "max-w-6xl mx-auto",
  ...
  listMoviesHeaderInner:
    "flex flex-col lg:flex-row items-center justify-between gap-6 mb-6",
  listMoviesTitle: "text-2xl lg:text-3xl font-bold",
  listMoviesSubtitle: "text-sm text-gray-400 mt-1",
  searchContainer:
    "w-full flex items-center justify-center lg:justify-end mt-4 lg:mt-0",
  searchBox:
    "relative w-full max-w-full sm:max-w-md md:max-w-lg lg:max-w-[540px] mx-auto lg:mx-0",
  searchInput:
    "w-full px-12 py-3 rounded-2xl text-sm sm:text-base md:text-lg bg-gray-800/50 border border-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent backdrop-blur-sm",
  searchIcon:
  ...
  filterButton:
    "filter-btn flex items-center gap-2 px-4 py-2 sm:py-3 rounded-xl font-medium text-sm transition-all duration-300 cursor-pointer",
  filterButtonActive:
    "bg-gradient-to-r from-red-600 to-red-700 text-white shadow-lg shadow-red-500/25",
  filterButtonInactive:
    "gradient-border text-gray-300 hover:bg-red-900/20 hover:text-white hover:border-red-500/40",
  ...
  errorContainer:
    "col-span-full p-6 text-center text-red-300 rounded-2xl gradient-border",
  ...
  cardDeleteButton:
    "absolute top-3 right-3 z-10 p-2 cursor-pointer rounded-full bg-red-700/90 hover:bg-red-800 text-white transition-colors",
  cardImage:
    "w-full h-44 sm:h-52 md:h-48 lg:h-52 object-contain transition-transform duration-500",
  cardContent: "p-4 sm:p-5",
  cardHeader: "flex items-start justify-between mb-3",
  cardTitle:
    "font-bold text-lg text-white truncate group-hover:text-red-300 transition-colors mb-1",
  cardCategories: "flex flex-wrap gap-1.5",
  cardCategory:
    "px-2 py-0.5 bg-gray-700/50 rounded-lg text-xs text-gray-300 border border-gray-600",
  cardRatingContainer: "flex flex-col items-end gap-2 ml-3",
  cardRating:
    "flex items-center gap-1.5 bg-yellow-500/20 px-3 py-1 rounded-full text-sm",
  cardRatingIcon: "text-yellow-400",
  cardRatingText: "text-yellow-400 text-sm font-bold",
  cardDuration:
    "flex items-center gap-1.5 bg-blue-500/20 px-3 py-1 rounded-full text-sm",
  cardDurationIcon: "text-blue-400",
  cardDurationText: "text-blue-400 text-sm",
  cardDescription:
    "text-gray-400 text-sm leading-relaxed line-clamp-3 mb-4 min-h-[56px]",
  cardActions: "flex items-center justify-between",
  cardViewButton:
    "flex items-center gap-2 px-4 md:px-2 md:text-xs py-2 bg-gradient-to-r from-red-600 to-red-700 rounded-xl text-white text-sm font-semibold hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg hover:shadow-red-500/25 cursor-pointer",
  cardTrailerButton:
    "flex items-center gap-2 px-3 py-2 gradient-border rounded-xl text-gray-300 text-sm hover:text-white hover:border-red-500/60 transition-all duration-300 cursor-pointer",
  cardTrailerIcon: "w-4 h-4 text-red-500",

  // Detail View Sidebar
  detailSidebar:
    "md:sticky md:top-6 lg:top-6 gradient-border rounded-2xl p-5 md:p-6 backdrop-blur-sm max-h-[auto] md:max-h-[75vh] lg:h-[85vh] overflow-y-auto",
  ...
  detailEmptyState:
    "flex flex-col items-center justify-center text-center py-12 md:py-16",
  detailEmptyIcon:
    "p-6 bg-gray-900/30 rounded-3xl border border-gray-700 backdrop-blur-sm",
  ...
  detailCloseButton:
    "flex-shrink-0 p-2.5 gradient-border rounded-xl text-gray-400 hover:text-white hover:border-red-500/60 transition-all duration-300 cursor-pointer",

  // Detail Sections
  detailThumbnail: "rounded-2xl overflow-hidden gradient-border",
  detailThumbnailImage: "w-full h-56 object-contain",
  detailGrid:
    "grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 gradient-border rounded-2xl",
  ...
  watchTrailerButton:
    "flex items-center justify-center gap-3 w-full py-4 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl text-white font-bold hover:from-red-700 hover:to-red-800 transition-all duration-300 cursor-pointer transform hover:scale-[1.02] shadow-lg",

  // Movie Details
  detailPoster: "w-full h-72 object-contain",
  detailInfoGrid:
    "grid grid-cols-1 sm:grid-cols-3 gap-6 p-4 sm:p-5 gradient-border rounded-2xl",
  ...
  showtimeItem:
    "flex items-center justify-between p-4 gradient-border rounded-2xl hover:border-red-500/60 transition-all duration-300 cursor-pointer",
  ...
  releaseSoonImage:
    "rounded-2xl overflow-hidden gradient-border mx-auto max-w-sm transform transition-transform duration-500",
  releaseSoonText: "text-gray-400 text-lg font-semibold",
  releaseSoonCategories: "flex justify-center gap-3",
  releaseSoonCategory:
    "px-4 py-2 bg-gray-700/50 rounded-full text-sm text-gray-300 border border-gray-600 font-medium",
  ...
  personAvatar:
    "w-20 h-20 object-cover rounded-2xl mb-3 mx-auto border-2 border-gray-600 group-hover:border-red-500 transition-all duration-300 group-hover:scale-105",
  personName: "font-semibold text-sm text-white truncate max-w-[100px] mx-auto",
  personRole:
    "text-gray-400 text-xs mt-1 px-2 py-1 bg-gray-700/50 rounded-full",

// CineGo / Admin / src / components / BookingsPage / BookingsPage.jsx
    ...
    <div className="min-h-screen bg-black text-gray-100 p-6 sm:p-10 bookings-font">
      <div className="max-w-6xl mx-auto">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {loading && (
            <div className="col-span-full text-center text-gray-400 py-8 border border-purple-800 rounded-lg flex items-center justify-center gap-3">
          ...
          {!loading && bookingsToShow.length === 0 && (
            <div className="col-span-full text-center text-gray-400 py-8 border border-purple-800 rounded-lg">
              No paid bookings.
            </div>
          )}

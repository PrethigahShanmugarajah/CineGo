...
export const bannerStyles = {
  ...
  overlay:
    "absolute inset-0 bg-gradient-to-b from-black/30 via-black/20 to-black/60 md:bg-transparent",

  // Content styles
  content:
    "relative z-10 flex items-center justify-start h-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto",
  contentInner: "max-w-2xl mt-10 md:mt-0",

  // Text styles
  title:
    "text-4xl sm:text-5xl md:text-7xl font-bold text-white mb-4 leading-tight",
  description: "text-sm sm:text-base md:text-lg text-gray-200 mb-6 max-w-lg",

  // Rating and genre styles
  ratingGenreContainer:
    "flex flex-wrap items-center gap-4 font-[pacifico] mb-6",
  ...
  bookButton:
    "bg-red-600 cursor-pointer hover:bg-red-700 px-4 sm:px-6 py-2.5 sm:py-3 rounded-full flex items-center transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl text-sm sm:text-base",
  infoButton:
    "bg-white/20 hover:bg-white/30 text-white backdrop-blur-sm px-4 sm:px-6 py-2.5 sm:py-3 rounded-full flex items-center transition-all duration-300 border border-white/30 text-sm sm:text-base",
...
export const navbarStyles = {
  ...
  // Layout
  container:
    "max-w-7xl mx-auto px-4 md:px-1 lg:px-1 xl:px-8 flex items-center justify-between",

  // Logo section
  logoContainer: "flex items-center gap-3 z-20 flex-shrink-0",
  logoIconContainer:
    "bg-black p-3 md:p-3 xl:p-3 lg:p-3 rounded-full border border-red-600",
  logoIcon: "h-4 w-4 md:h-2 md:w-2 lg:h-4 lg:w-4 xl:w-4 xl:h-4  text-red-500",
  logoText:
    "text-lg md:text-sm xl:text-lg lg:tex-lg font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-red-200 font-[pacifico]",

  // Desktop navigation
  desktopNav:
    "hidden lg:flex absolute left-1/2 transform -translate-x-1/2 z-10 items-center bg-black/70 backdrop-blur-md rounded-full px-3 py-2 gap-2 shadow-inner",
  ...
  logoutButton:
    "flex items-center gap-2 md:px-1.5 px-4 lg:px-4 xl:px-4  py-2 rounded-full bg-gradient-to-r from-gray-700 to-gray-800 text-white text-sm font-semibold border border-red-600/20",
  loginButton:
    "flex items-center gap-2 px-4 py-2 md:px-1.5 lg:px-4 xl:px-4 rounded-full bg-gradient-to-r from-red-300 to-red-700 text-white text-sm font-semibold border border-red-600/20",
  authIcon: "h-4 w-4",
  ...
  mobileMenuPanel:
    "md:hidden absolute left-4 right-4 top-full mt-6 bg-black backdrop-blur-md rounded-2xl p-4 shadow-xl",
...
export const bookingsPageStyles = {
  ...
  noBookings:
    "col-span-full text-center text-gray-400 py-8 border border-red-800 rounded-lg",
  ...
  // Booking card
  bookingCard:
    "bg-gradient-to-b from-gray-900 to-black rounded-2xl p-4 border border-red-800 shadow-xl",
  cardContent: "flex flex-col lg:flex-row items-start gap-4",
  posterContainer:
    "w-full lg:w-24 h-44 lg:h-36 flex-shrink-0 overflow-hidden rounded-md border border-red-700",
  ...
  // Expanded details
  expandedDetails:
    "mt-4 border-t border-red-900/40 pt-3 text-sm text-gray-300 space-y-3 transition-all duration-200 ease-in-out",
  ...
  seatItem:
    "px-3 py-1 rounded-md bg-black/40 border border-red-800 flex items-center gap-2 text-sm",
  ...
  detailsButton:
    "inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-red-700 bg-black/30 hover:bg-black/40 transition",
  ...
  modalContent:
    "relative max-w-md w-full bg-gray-900 rounded-2xl p-6 border border-red-800 shadow-2xl text-gray-100",
...
export const contactStyles = {
  ...
  pageContainer:
    "min-h-screen pt-15 bg-black text-white py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden",

  // Background elements
  bgGradient:
    "absolute top-0 left-0 w-full h-48 bg-gradient-to-b from-red-900/20 to-transparent",
  bgBlob1:
    "absolute top-40 right-10 w-32 h-32 bg-red-500/10 rounded-full filter blur-xl",
  bgBlob2:
    "absolute bottom-20 left-8 w-24 h-24 bg-red-700/10 rounded-full filter blur-xl",
  ...
  cardGradient:
    "absolute -inset-2 bg-gradient-to-r from-red-600 to-red-800 rounded-2xl blur-md opacity-50",
  cardContainer:
    "relative bg-gray-800 rounded-2xl p-6 shadow-2xl border border-red-500/30",
  cardBadge:
    "absolute -top-3 left-6 bg-red-600 text-white px-4 py-1 rounded-full text-sm font-bold flex items-center",
  cardIcon: "h-4 w-4 mr-1",

  // Form styles
  formTitle:
    "text-2xl font-bold mb-6 font-[pacifico] text-red-400 flex items-center pt-2",
  formTitleIcon: "mr-3",
  form: "space-y-5",
  ...
  input:
    "w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300",
  textarea:
    "w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300",
  select:
    "w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300",
  ...
  // Button styles
  submitButton:
    "w-full bg-gradient-to-r from-red-600 to-red-800 text-white py-3 px-6 rounded-full font-bold flex items-center justify-center transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl cursor-pointer hover:to-red-900 group",
  ...
  emergencyCardGradient:
    "absolute -inset-2 bg-gradient-to-r from-amber-600 to-amber-800 rounded-2xl blur-lg opacity-50",
  emergencyCard:
    "relative bg-gray-800 rounded-2xl p-5 shadow-2xl border border-amber-500/30",
  ...
  emergencyHotline:
    "bg-amber-600 text-white text-sm font-bold px-3 py-1 rounded-full",
...
export const moviesPageStyles = {
  // Layout
  container:
    "min-h-screen pt-20 bg-gradient-to-b from-gray-900 to-black text-white",
  ...
  showMoreButton:
    "px-6 py-3 cursor-pointer rounded-full text-white border border-white/10 bg-gradient-to-b from-red-500 to-red-700 transition",
};
...
export const footerStyles = {
  // Main container
  footer:
    "relative bg-black text-white overflow-hidden border-t border-red-800",

  // Animated border
  animatedBorder:
    "absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-red-600 to-transparent animate-pulse",

  // Background elements
  bgContainer: "absolute inset-0 opacity-5 pointer-events-none",
  bgGlow1:
    "absolute -top-12 -left-12 w-40 h-40 sm:w-56 sm:h-56 md:w-72 md:h-72 bg-red-600 rounded-full filter blur-3xl animate-pulse",
  bgGlow2:
    "absolute -right-16 -bottom-16 w-56 h-56 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-red-800 rounded-full filter blur-3xl",
  ...
  gridContainer:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols- xl:grid-cols-4 gap-8 sm:gap-10 mb-12 md:mb-16",

  // Brand section
  brandContainer: "lg:col-span-1",
  brandLogoContainer: "flex items-center mb-4 sm:mb-6",
  logoGlow:
    "absolute -inset-1 sm:-inset-2 bg-red-600 rounded-full blur opacity-75 animate-pulse",
  logoContainer:
    "relative bg-black p-2 sm:p-3 rounded-full border border-red-600",
  ...
  socialLink:
    "text-gray-400 p-2 sm:p-3 rounded-full transform transition-all duration-300 hover:scale-110 hover:text-red-500 border border-gray-800 hover:border-red-600",
  socialIcon: "h-4 w-4 sm:h-5 sm:w-5",

  // Section headers
  sectionHeader:
    "text-lg sm:text-xl font-bold mb-6 sm:mb-8 flex items-center text-red-600",
  sectionDot: "w-2.5 h-2.5 bg-red-600 rounded-full mr-3 animate-pulse",

  // Links
  linksList: "space-y-3 sm:space-y-4",
  linkItem:
    "text-gray-400 hover:text-red-500 transition-all duration-300 flex items-center group transform hover:translate-x-2 text-sm sm:text-base",
  linkDot:
    "w-2 h-2 bg-red-600 rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 inline-block",
  ...
  // Divider
  divider:
    "relative h-px bg-gradient-to-r from-transparent via-red-600 to-transparent mb-8 sm:mb-10",
  dividerIconContainer:
    "absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black p-1.5 sm:p-2 rounded-full border border-red-600",
  ...
  designedByLink:
    "text-gray-500 font-medium hover:text-blue-500 transition-colors duration-300 text-xs sm:text-sm",
  ...
  scrollTopButton:
    "fixed bottom-4 sm:bottom-6 right-4 sm:right-6 cursor-pointer bg-red-700 hover:bg-red-600 text-white p-3 sm:p-4 rounded-full shadow-lg transition-all duration-300 transform hover:-translate-y-1 z-20 group border border-red-500",
...
export const moviesStyles = {
  ...
  // Movie link
  movieLink:
    "w-full block rounded-2xl overflow-hidden transform transition-transform duration-300 ",

  // Movie image
  movieImage:
    "w-full rounded-2xl object-cover h-70 sm:h-56 md:h-64 lg:h-56 xl:h-70",
...
export const loginStyles = {
  // Page container
  pageContainer:
    "min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 to-black p-4 relative overflow-hidden",

  // Back button
  backButtonContainer: "mb-4 sm:mb-6 xl:mb-2 md:mb-0",
  backButton:
    "inline-flex xl:-ml-100 md:-ml-30 items-center text-red-400 hover:text-red-300 transition-all duration-300 group focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2",
  backButtonIcon:
  ...
  cardHeader:
    "relative h-2 bg-gradient-to-r from-red-700 via-red-600 to-red-700",
  ...
  input:
    "w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-800/60 text-white rounded-lg focus:ring-2 focus:ring-red-500 focus:outline-none transition-all duration-200 border border-gray-700 placeholder-gray-500",
  inputWithIcon:
    "w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-800/60 text-white rounded-lg focus:ring-2 focus:ring-red-500 focus:outline-none transition-all duration-200 border border-gray-700 pr-10",
  ...
  // Submit button
  submitButton:
    "w-full bg-gradient-to-r from-red-700 to-red-800 text-white font-bold py-2.5 sm:py-3 px-4 rounded-full hover:opacity-90 transition-all cursor-pointer duration-300 transform focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 shadow-lg shadow-red-900/30",
  ...
  footerLink:
    "text-red-400 hover:text-red-300 font-medium transition duration-200 underline hover:no-underline",
...
export const newsStyles = {
  // Main container
  container:
    "min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-100 text-gray-900",
  ...
  latestNewsButton:
    "ml-auto inline-flex cursor-pointer bg-gradient-to-r from-red-400 to-red-500 items-center gap-2 text-white px-3 sm:px-4 py-2 rounded-full hover:shadow-lg transition",
  buttonIcon: "size-16",
  buttonText: "text-xs sm:text-sm",

  // Hero stripe
  heroStripe:
    "mt-5 sm:mt-6 flex items-center gap-3 overflow-hidden rounded-full bg-gradient-to-r from-red-50 via-white to-red-50 p-1",
  ...
  // Hero card
  heroCard:
    "relative rounded-3xl overflow-hidden bg-white shadow-xl transform transition hover:shadow-2xl lg:col-span-2",
  ...
  heroOverlay:
    "absolute inset-0 bg-gradient-to-t from-black/75 to-transparent opacity-0 animate-fadeIn",
  heroContent:
    "absolute left-5 sm:left-8 bottom-5 sm:bottom-8 right-5 sm:right-8",
  heroCategory:
    "inline-block bg-red-600 text-white text-xs px-3 py-1 rounded-full font-semibold",
  heroTitle:
    "mt-3 sm:mt-4 text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold leading-tight text-white",
  heroExcerpt:
    "mt-2 text-xs sm:text-sm md:text-base text-gray-300 max-w-full sm:max-w-3xl",
  ...
  stripGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 gap-4",

  // Article card
  articleCard:
    "group relative overflow-hidden rounded-2xl bg-white border border-gray-100 p-0 shadow-md transform transition hover:-translate-y-2 hover:shadow-xl flex flex-col h-full",
  articleImage: "relative h-40 sm:h-36 md:h-32 w-full",
  articleImg: "w-full h-full object-cover transition-transform duration-500 ",
  articleCategory:
    "absolute left-3 bottom-3 bg-red-600 text-white px-2 py-1 rounded-md text-xs font-semibold",
  ...
  sidebar: "space-y-6",
  sidebarCard:
    "relative rounded-2xl overflow-hidden bg-white shadow-lg transform transition hover:shadow-2xl",
  sidebarCardInner: "flex items-stretch",
  sidebarImage:
    "w-28 sm:w-32 h-28 sm:h-32 overflow-hidden flex-shrink-0 rounded-l-2xl",
  sidebarImg: "w-full h-full object-cover",
  sidebarContent: "p-3 sm:p-4 flex-1",
  sidebarCategory:
    "text-xs bg-red-50 text-red-600 px-2 py-1 rounded-md font-semibold",
  ...
  // Subscribe card
  subscribeCard:
    "rounded-2xl p-4 sm:p-6 bg-gradient-to-b from-white to-red-50 border border-red-100 shadow-md",
  ...
  subscribeInput:
    "flex-1 px-3 sm:px-4 py-2 rounded-xl border border-gray-200 outline-none text-sm",
  subscribeButton:
    "inline-flex cursor-pointer items-center gap-2 bg-red-600 text-white px-2 sm:px-4 py-2 rounded-xl shadow hover:bg-red-700 transition text-sm",
};
...
export const releasesStyles = {
  // Page container
  pageContainer:
    "min-h-screen pt-25 bg-gradient-to-br from-gray-900 to-black text-white p-6",

  // Header section
  headerContainer: "text-center mb-12 mt-6",
  headerTitle:
    "font-bold text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-red-400 via-red-600 to-pink-500 font-[pacifico]",
  headerSubtitle: "mt-4 text-xl text-gray-300",

  // Movie grid
  movieGrid:
    "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 gap-6 max-w-6xl mx-auto",
...
export const seatSelectorStyles = {
  // Page container
  pageContainer:
    "min-h-screen bg-gradient-to-b from-black to-gray-900 text-white py-8 px-4",
  ...
  backButton:
    "inline-flex items-center gap-2 text-red-300 hover:text-white transition-all px-4 py-3 rounded-xl hover:bg-red-900/20",
  backButtonIcon: "size-6",
  titleContainer: "flex-1 text-center",
  movieTitle:
    "text-4xl md:text-6xl py-1 font-bold tracking-wider mb-2 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent",
  showtimeText:
  ...
  screen:
    "mx-auto bg-gradient-to-b from-gray-800 to-gray-900 rounded-t-2xl shadow-2xl text-center p-6 relative",
  screenText: "text-lg font-semibold text-gray-300 tracking-widest",
  screenSubtext: "text-xs text-gray-200 mt-2",

  // Main content
  mainContent:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-3xl p-8 border border-red-700/10 shadow-2xl",
  sectionHeader: "flex justify-center mb-6",
  sectionTitleContainer: "text-center",
  sectionTitle:
    "text-2xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent font-bold mb-2 flex items-center justify-center gap-2",
  ...
  selectedSeatBadge:
    "px-3 py-1 rounded-full text-sm bg-red-500/20 text-red-300",

  // Total amount
  totalContainer:
    "p-3 bg-gradient-to-r from-red-900/20 to-transparent rounded-xl",
  ...
  clearButton:
    "flex-1 px-4 py-3 rounded-full cursor-pointer bg-gray-800 text-gray-300 hover:bg-gray-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed",
  confirmButton:
    "flex-1 px-4 py-3 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white font-bold hover:from-red-700 hover:to-red-800 transition-all transform cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed",
...
export const signUpStyles = {
  // Main container
  container:
    "min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-950 via-black to-gray-900 p-4 relative overflow-hidden",
  ...
  // Back button
  backButton:
    "absolute -top-10 -left-1 xl:-left-90 lg:-left-40 cursor-pointer flex items-center text-red-400 hover:text-red-300 transition-all duration-300 group mb-4",
  ...
  cardHeader:
    "relative h-1 bg-gradient-to-r from-red-600 via-red-500 to-red-600",
...
export const trailersStyles = {
  // Main container
  container:
    "min-h-screen bg-gradient-to-b from-gray-100 to-gray-300 text-gray-900",
  ...
  controlButton:
    "p-2 rounded-full bg-gray-100 hover:bg-red-100 text-red-600 transition-colors",
  ...
  carouselOverlay:
    "absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-2",
  ...
  trendingItem:
    "flex items-center space-x-3 p-2 rounded-lg hover:bg-red-50 cursor-pointer transition-colors",
  ...
  playButton:
    "bg-red-600 hover:bg-red-700 cursor-pointer rounded-full p-4 md:p-5 transition-all transform ",
  ...
  creditsGrid:
    "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 items-start",
...
export const seatSelectorHStyles = {
  ...
  clearButton:
    "flex-1 px-4 py-3 rounded-full cursor-pointer bg-gray-800 text-gray-300 hover:bg-gray-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed",
  confirmButton:
    "flex-1 px-4 py-3 rounded-full cursor-pointer bg-gradient-to-r from-red-600 to-red-700 text-white font-bold hover:from-red-700 hover:to-red-800 transition-all transform  disabled:opacity-50 disabled:cursor-not-allowed",
...
export const movieDetailStyles = {
  ...
  backButton:
    "inline-flex items-center gap-2 text-red-300 hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-red-900/20",
  backIcon: "size-18",
  ...
  movieTitle:
    "text-3xl sm:text-5xl md:text-5xl lg:text-7xl py-1 font-bold tracking-wider mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent",
  movieMeta:
  ...
  genreTag:
    "px-3 py-1 bg-red-900/40 rounded-full text-red-300 text-sm border border-red-700/30",
  ...
  posterCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-6 border border-red-700/20 shadow-2xl",
  ...
  trailerButton:
    "w-full mt-6 flex items-center justify-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold text-base sm:text-lg transition-all shadow-lg",
  trailerIcon: "size-18",
  ...
  // Showtimes section
  showtimesCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl mb-6",
  showtimesTitle:
    "text-2xl sm:text-4xl font-bold mb-6 text-red-300 text-center flex items-center justify-center gap-2",
  ...
  timeButton: {
    ...
    inactive:
      "bg-gray-800/40 text-gray-200 border-gray-700/50 hover:bg-red-600 hover:text-white hover:border-red-500/50",
  },
  soldOutBadge:
    "ml-2 px-2 py-0.5 rounded-full text-xs bg-red-700/90 text-white font-bold",

  // Proceed button
  proceedButton: "mt-4 sm:mt-6 text-center",
  bookButton:
    "px-6 py-2.5 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white font-bold text-base sm:text-lg shadow-2xl hover:from-red-700 hover:to-red-800 transition-transform transform hover:scale-105",

  // Cast section
  castCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl",
  castTitle:
    "text-xl sm:text-3xl font-bold mb-4 sm:mb-6 text-red-300 text-center flex items-center justify-center gap-2",
  castIcon: "h-5 w-5",
  castGrid:
  ...
  castImage:
    "w-20 h-20 rounded-full object-cover mx-auto border-2 border-red-600/30 group-hover:border-red-400 transition-colors",
  ...
  // Story section
  storyCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl mb-8",
  storyTitle:
    "text-2xl sm:text-4xl font-bold mb-4 sm:mb-6 text-red-300 text-center",
  storyText:
  ...
  crewCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl text-center",
  ...
  crewImage:
    "w-20 h-20 sm:w-24 sm:h-24 rounded-full object-cover border-2 border-red-600/30 mb-3 sm:mb-4",
  ...
  closeButton:
    "absolute right-0 sm:-top-10 -top-6 sm:-right-4 text-white hover:text-red-400 z-10",
  closeIcon: "size-36",
...
export const movieDetailHStyles = {
  ...
  movieTitle:
    "text-2xl sm:text-4xl md:text-5xl lg:text-7xl py-1 font-bold tracking-wider mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent",
  movieInfoContainer:
  ...
  genre:
    "px-3 py-1 bg-red-900/40 rounded-full text-red-300 text-xs sm:text-sm border border-red-700/30",
  ...
  posterImage:
    "w-full h-full object-cover rounded-xl transition-transform duration-300",
  trailerButton:
    "w-full mt-5 sm:mt-6 flex items-center justify-center gap-3 px-5 py-3 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white font-semibold text-sm sm:text-base transition-all shadow-lg",
  ...
  showtimesCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl mb-6",
  showtimesTitle:
    "text-xl sm:text-2xl md:text-3xl font-bold mb-4 sm:mb-6 text-red-300 text-center flex items-center justify-center gap-2",
  ...
  showtimeButtonSelected:
    "bg-red-600 text-white border-red-500/50 transform scale-105",
  ...
  bookNowButton:
    "px-5 py-2.5 rounded-full bg-gradient-to-r from-red-600 to-red-700 text-white font-bold text-sm sm:text-base shadow-2xl hover:from-red-700 hover:to-red-800 transition-transform transform hover:scale-105",

  // Cast section
  castCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl",
  castTitle:
    "text-lg sm:text-2xl font-bold mb-4 text-red-300 text-center flex items-center justify-center gap-2",
  ...
  castImageContainer: "relative mx-auto mb-3",
  castImage:
    "w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover mx-auto border-2 border-red-600/30 group-hover:border-red-400 transition-colors",
  ...
  storyCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl mb-8",
  storyTitle:
    "text-lg sm:text-2xl md:text-3xl font-bold mb-4 text-red-300 text-center",
  storyText:
  ...
  crewCard:
    "bg-gradient-to-br from-black/80 to-gray-900 rounded-2xl p-4 sm:p-8 border border-red-700/20 shadow-2xl text-center",
  crewTitle:
    "text-lg sm:text-2xl md:text-3xl font-bold text-red-300 flex items-center justify-center gap-3 mb-4",
  crewIcon: "h-5 w-5 text-red-400",
  crewContent: "flex flex-col items-center",

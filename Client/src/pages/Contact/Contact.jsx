        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="relative">
              ...
              <div className="relative bg-gray-800 rounded-2xl p-6 shadow-2xl border border-purple-500/30">
                <div className="absolute -top-3 left-6 bg-purple-600 text-white px-4 py-1 rounded-full text-sm font-bold flex items-center">
                  <Info className="h-4 w-4 mr-1" /> Cinema Info
                </div>
                <h2 className="text-2xl font-bold mb-6 font-[pacifico] text-purple-400 flex items-center pt-2">
                  Contact Information
                </h2>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start group">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold mb-1">
                        Vavuniya Cinema Complex
                      </h3>

                      <p className="text-gray-300">
                        Located in Vavuniya town near the main bus stand.
                      </p>
                      <p className="text-gray-300">
                        Kandy Road, Vavuniya • Open 9 AM – 11:30 PM
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-gray-800 rounded-2xl p-5 shadow-2xl border border-blue-500/30">
                ...
                <p className="text-gray-300 text-sm mb-3">
                  Facing ticket, seat, or showtime issues? Our team is ready to
                  help you quickly before your movie starts.
                </p>

                <div className="flex items-center">
                  <div className="bg-blue-600 text-white text-sm font-bold px-3 py-1 rounded-full">
                    Support Line: +94 777654321
                  </div>
                  <span className="ml-3 text-xs text-blue-400">
                    Active during movie hours
                  </span>
                </div>
              </div>
            </div>
